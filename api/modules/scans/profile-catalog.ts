import { validateScanProfileCatalog } from "./profile-catalog-operations";
...
export const LEGACY_FULL_SECURITY_CATALOG_ENTRY = catalogEntry({
...
export * from "./profile-catalog-operations";
