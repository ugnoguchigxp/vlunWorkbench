...
function summarizeCommunity(community: CommunityCandidate): string {
...
function maxSeverityForFindings(
	context: GraphContext,
	findingIds: string[],
): StaticIntelligenceSeverity {
	return (
...
function evidenceQualityForFindings(
	exportPayload: StaticIntelligenceExportV1,
	findingIds: string[],
): StaticIntelligenceEvidenceQuality {
...
function sortBasis(values: RiskCommunityBasis[]): RiskCommunityBasis[] {
...
function compareCommunities(left: RiskCommunity, right: RiskCommunity): number {
